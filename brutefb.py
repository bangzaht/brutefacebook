...
def siapa():
	os.system('clear')
	nama = raw_input("\033[1;97mSiapa nama kamu syg:v ? \033[1;91m: \033[1;92m")
	if nama =="":
...
def loginSC():
	...
	if username =="brute" and password =="facebook":
